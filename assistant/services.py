...
class AssistantService:
    """Built-in local assistant that answers from real platform data
    respecting the permissions of the current user.
    """
    ...
    def get_reply(user, institution, question, conversation=None):
        ...
        # Hard server-side ethics gate (cannot be bypassed).
